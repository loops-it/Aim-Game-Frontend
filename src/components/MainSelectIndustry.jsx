...
export default function MainSelectIndustry({ options, label, placeholder, value, onChange, disabled, variant }) {
    ...
    return (
        <div className="relative">
            ...
            <Combobox disabled={disabled} value={value || null} onChange={onChange}>
